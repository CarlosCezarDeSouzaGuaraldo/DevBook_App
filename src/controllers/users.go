...
func UpdateUser(w http.ResponseWriter, r *http.Request) {
	...
	if userID != userIDOnToken {
		responses.Error(w, http.StatusForbidden, errors.New("It's not possible updated an other user"))
		return
	}
...
func DeleteUser(w http.ResponseWriter, r *http.Request) {
	...
	if userID != userIDOnToken {
		responses.Error(w, http.StatusForbidden, errors.New("It's not possible remove an other user"))
		return
	}
...
// FollowUser allow that an user follow an other
func FollowUser(w http.ResponseWriter, r *http.Request) {
	...
	if followerID == userID {
		responses.Error(w, http.StatusForbidden, errors.New("It's not possible follow yourself"))
		return
	}
...
// UnfollowUser allow the user unfollow another one
func UnfollowUser(w http.ResponseWriter, r *http.Request) {
	...
	if followerID == userID {
		responses.Error(w, http.StatusForbidden, errors.New("It's possible stopping follow yourself"))
		return
	}
...
// GetFollowers get all followers from user
...
// GetFollowing get the users that follower an user is following
...
func UpdatePassword(w http.ResponseWriter, r *http.Request) {
	...
	if userIDOnToken != userID {
		responses.Error(w, http.StatusForbidden, errors.New("It's not possible update another user's password"))
		return
	}
	...
	repository := repositories.NewUserRepository(db)
	databasePassword, err := repository.FindPassword(userID)
	if err != nil {
		responses.Error(w, http.StatusInternalServerError, err)
		return
	}

	if err = security.CheckPassword(password.Current, databasePassword); err != nil {
		responses.Error(w, http.StatusUnauthorized, errors.New("The current password isn't the same"))
		return
	}
